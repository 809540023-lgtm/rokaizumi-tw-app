...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    var extra: any = {"日本介護用品專賣":["Japanese Care Products","日本介護用品専門店"],"企業合作":["Business","法人提携"],"登入":["Sign In","ログイン"],"購物車":["Cart","カート"],"🇯🇵 日本大阪直送・服務台灣家庭已 8 年":["🇯🇵 Direct from Osaka, Japan · Serving Taiwan families for 8 years","🇯🇵 日本・大阪から直送・台湾のご家庭に8年"],"日本職人嚴選介護用品，":["Japanese artisan-selected care products,","日本の職人が厳選した介護用品、"],"讓長輩生活":["helping seniors live","高齢者の暮らしを"],"更自在":["more comfortably","より快適に"],"立刻選購 →":["Shop Now →","今すぐ購入 →"],"免費索取選品指南":["Get a Free Buying Guide","無料で選び方ガイドを請求"],"搜尋":["Search","検索"],"正品保証":["Authentic","正規品保証"],"正品保證":["Authentic Guarantee","正規品保証"],"免關稅":["Duty-Free","関税不要"],"3 年保固":["3-Year Warranty","3年保証"],"中日客服":["JP/CN Support","日中対応サポート"],"精選品質":["Curated Quality","厳選品質"],"嚴選日本優質介護品牌":["Selected premium Japanese care brands","日本の優良介護ブランドを厳選"],"安心保障":["Peace of Mind","安心保証"],"正品保證，品質有保證":["Genuine products, quality guaranteed","正規品・品質保証"],"快速配送":["Fast Delivery","迅速配送"],"專業包裝，安全送達":["Professional packaging, safe delivery","丁寧な梱包で安全にお届け"],"11 大專業分類":["11 Professional Categories","11の専門カテゴリー"],"從拐杖到電動床，":["From canes to electric beds,","杖から電動ベッドまで、"],"每一個生活場景都備妥":["every living scenario covered","あらゆる生活シーンに対応"],"查看全部":["View All","すべて見る"],"本月熱銷":["Best Sellers This Month","今月の人気商品"],"看全部熱銷 →":["View All Best Sellers →","人気商品をすべて見る →"],"詳情":["Details","詳細"],"加入購物車":["Add to Cart","カートに追加"],"本週新品":["New This Week","今週の新商品"],"看全部新品 →":["View All New →","新商品をすべて見る →"],"為什麼選擇我們":["Why Choose Us","選ばれる理由"],"大阪直送":["Direct from Osaka","大阪直送"],"日本當地嚴選採購，直送台灣，品質有保障。":["Selected locally in Japan and shipped direct to Taiwan, quality assured.","日本国内で厳選し台湾へ直送、品質も安心。"],"專業介護":["Care Expertise","専門的な介護"],"專注高齡照護用品，貼近長輩實際需求。":["Focused on elderly care products that meet seniors' real needs.","高齢者ケア用品に特化し、実際のニーズに寄り添います。"],"安心售後":["Reliable After-Sales","安心のアフターサービス"],"正品保證、專人服務，購物無後顧之憂。":["Genuine products and dedicated service for worry-free shopping.","正規品・専任対応で安心してお買い物いただけます。"],"企業 / 機構合作":["Business / Institutional Partnership","法人・施設との提携"],"長照中心 . 醫療院所 . 居家照護業者":["Care centers · Medical institutions · Home care providers","介護施設・医療機関・在宅介護事業者"],"專屬採購方案":["Dedicated Procurement Plans","専用調達プラン"],"批發折扣：訂購量越大、折扣越多，最高再省 22%":["Wholesale discounts: bigger orders, bigger savings — up to 22% off","卸割引：注文量が多いほどお得、最大22%オフ"],"月結發票：開立統編，月結 30 / 60 天可談":["Monthly invoicing: business invoices, net 30/60 terms negotiable","月締め請求書：適格請求書発行、30/60日締め相談可"],"備品保留：常用品項可預留庫存，下單隔日出貨":["Stock reservation: keep frequent items in stock, next-day shipping","在庫確保：定番品を予約在庫、翌日出荷"],"立即洽詢報價 →":["Request a Quote →","今すぐ見積もり依頼 →"],"已服務 140+ 間台灣長照與醫療機構":["Serving 140+ Taiwanese care and medical institutions","台湾の介護・医療機関140社以上にご利用いただいています"],"顧客回饋":["Customer Reviews","お客様の声"],"您的使用心得，是我們持續進步的動力":["Your feedback drives our continuous improvement","皆様の声が私たちの励みです"],"常見問題":["FAQ","よくある質問"],"下單前最常被問的 6 件事":["The 6 most common questions before ordering","ご注文前によくある6つの質問"],"Q1. 從日本送台灣需要報關嗎？要不要繳關稅？":["Q1. Is customs clearance needed from Japan to Taiwan? Are duties owed?","Q1. 日本から台湾への発送に通関は必要？関税はかかる？"],"Q2. 多久可以收到貨？真的 7 天嗎？":["Q2. How long until delivery? Really 7 days?","Q2. 何日で届く？本当に7日？"],"Q3. 怎麼確認商品適合我家長輩？":["Q3. How do I confirm a product suits my elderly family member?","Q3. 商品が家族の高齢者に合うかどう確認する？"],"Q4. 商品壞了怎麼辦？真的有 3 年保固嗎？":["Q4. What if a product breaks? Is there really a 3-year warranty?","Q4. 商品が壊れたら？本当に3年保証がある？"],"Q5. 可以開立統一發票嗎？機構採購流程？":["Q5. Can you issue official invoices? What is the institutional procurement process?","Q5. 適格請求書は発行できる？施設の調達手続きは？"],"Q6. 不滿意可以退貨嗎？":["Q6. Can I return items if unsatisfied?","Q6. 満足できない場合は返品できる？"],"訂閱電子報，立刻領 NT$ 200 優惠券":["Subscribe to our newsletter and get a NT$200 coupon","メルマガ登録でNT$200クーポンプレゼント"],"立即訂閱":["Subscribe Now","今すぐ登録"],"日本食品・日用品":["Japanese Food & Daily Goods","日本食品・日用品"]};
    for (var ek in extra) { if (!dict[ek]) dict[ek] = { zh: ek }; dict[ek].en = extra[ek][0]; dict[ek].ja = extra[ek][1]; }
    ...
    function trNode(root: any) {
      ...
      for (var a = 0; a < nodes.length; a++) {
        ...
        else if (dict[trimmed] && dict[trimmed][language]) out = src.replace(trimmed, dict[trimmed][language]);
        else out = src;
