              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="max-w-xl mx-auto mb-8">
                  <div className="relative">
                    <input
                      type="text"
                      placeholder={language === 'zh' ? '搜尋產品...' : language === 'ja' ? '商品を検索...' : 'Search products...'}
                      value={searchQuery}
                ...
                <div className="flex gap-4 justify-center flex-wrap">
                  ...
                  <Link href="/videos">
                    <a className="bg-[#0ABAB5] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#089B96] transition-colors shadow-lg inline-block">
            ...
            <section className="py-16 bg-[#fef9f3]">
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <Link href="/videos">
                    <a className="text-[#DC2626] hover:text-[#B91C1C] font-semibold">
                      {t('home.viewAll')} →
                    </a>
                  </Link>
                </div>
